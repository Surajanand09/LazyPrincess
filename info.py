...
API_ID = int(environ.get('API_ID', '21224265'))
API_HASH = environ.get('API_HASH', 'f07513f20601bd795de0989bf1463270'))
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5814711863').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002066985819').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://whitedevil09:mongodb78725@cluster0.9d22ro5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "LazyDeveloper")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL','-1001946658728'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL','-1002066985819')).split()]
...
URL = "https://lazyprincess-c4bu.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://lazyprincess-c4bu.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://lazyprincess-c4bu.onrender.com".format(FQDN)
else:
    URL = "https://lazyprincess-c4bu.onrender.com".format(FQDN)
